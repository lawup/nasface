...
if __name__ == "__main__" :
    ...
    '''
    #ImagePath=r'./faces/uploadpic_1528272773' #原始的图像路径
    #savePathDetect=r'./faces/uploadpic_1528272773/1detect'#保存中间检测到的图像的路径
    #savePathAligned=r'./faces/uploadpic_1528272773/2align'#对齐后的人脸图像的保存路径
    #savePathCroped=r'./faces/uploadpic_1528272773/3croped'

    Ps = sys.argv[1]	
    ImagePath=r'./'+Ps+'' #原始的图像路径
    savePathDetect=r'./'+Ps+'/1detect'#保存中间检测到的图像的路径
    savePathAligned=r'./'+Ps+'/2align'#对齐后的人脸图像的保存路径
    savePathCroped=r'./'+Ps+'/3croped'	
	
    test(ImagePath,savePathDetect,savePathAligned,savePathCroped,tag_recover=True,savesize=[256,256])
